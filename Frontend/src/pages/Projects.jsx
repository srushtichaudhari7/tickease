  ...
  return (
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        {/* Sorting */}
        <div className="bg-gray-800 p-4 rounded-lg shadow-sm mb-6 flex flex-wrap items-center justify-between">
          
            <div className="flex items-left text-xl" >
              Find all your projects here!!
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {getFilteredProjects().map((project) => (
            <div
              key={project._id}
              className="bg-gray-800 shadow-md hover:shadow-lg rounded-lg overflow-hidden transition-shadow duration-300"
            >
            ...
            <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-500 text-black rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-gray-400"
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full border border-gray-500 text-black rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-gray-400"
